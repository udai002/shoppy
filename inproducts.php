   ...
   <table class="table" id="Table1">
    ...
    while ($row16 = mysqli_fetch_assoc($result16)) {
      ...
      echo ' <tr>
          ...
          <td>' . $prod_uid . '</td>
          <td>' . $prod_price . '</td>
          <td><form action="partials/_stockhandles.php?prodid='.$prod_id.'" method="post"><input type="hidden" name="stock"><button class="btn btn-primary">'.$sta_change.'</button></form></td>
