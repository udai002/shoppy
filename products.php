...
<body onload="lood()">
  ...
  <div class="container procont my-5">
    ...
    while ($rows = mysqli_fetch_assoc($result2)) {
      ...
      $prod_name = $rows['pro_title'];
      $prod_descrip = $rows['product_descrip'];
      $prod_price = $rows['prod_price'];
      $Prod_uniq = $rows['prod_uniq'];
      ...
      if ($discount_amount != $discount_percent) {
        $discount_percent ='<strike>'.$prod_price.'</strike> '.$discount_percent . '%';
      } else {
      ...
      echo ' <div class="media my-3 pt-3 ">
               ...
               <div class="media-body">
                   ...
                   <div class="mb-2">
                      <b>&#8377;' . $discount_amount . ' <small class="text-danger" >' . $discount_percent . '</small></b><br>
                   </div>
    ...
    ?>
    <!-- <form action="/shoppyproject/carthandles.php?prodid='.$prod_id.' " method="post">
           <input type="hidden" name="quntity" value="1">
       </form> -->
